...
public class UpgradeFastCanvasJNI {
	// Native methods
	...
	public static native boolean addPngTexture(Object mgr, String path, int id, UpgradeFastCanvasTextureDimension dim); // id's must be from 0 to numTextures-1
	...
	// Load library
	static {
		System.loadLibrary("UpgradeFastCanvasJNI");
	}
}
